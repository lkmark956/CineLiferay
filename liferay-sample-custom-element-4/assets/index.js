...
import { MyMoviesPage } from './components/MyMoviesPage.js';
import { TopReviewsPage } from './components/TopReviewsPage.js';
...
function App() {
	...
	const renderView = () => {
		switch (currentView) {
			...
			case 'favorites':
				return React.createElement(FavoritesPage);
			case 'my-movies':
				return React.createElement(MyMoviesPage);
			case 'top-reviews':
				return React.createElement(TopReviewsPage);
			default:
				return React.createElement(HomePage);
		}
	};
